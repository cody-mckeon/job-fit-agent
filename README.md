...
Resume strategy prioritizes selected AI systems projects when space allows: Marketing Intelligence OS, AI Product Design Operating System, Job Fit Agent, and RWLV Priority Governor Agent. AI Enablement Manager, AI Transformation, AI Operations, AI Implementation, AI Solutions Engineer, Product Operations AI, and Marketing Operations AI roles prioritize Marketing Intelligence OS near the top of the project section. For limited-space AI enablement or marketing operations roles, use its strongest three bullets: marketing intake/use-case/reporting workflow structure, repeatable campaign/website/UTM/CTA/booking-intent analysis workflows, and internal AI enablement through real workflow improvements. Enterprise Solutions Engineer, Solutions Engineer, Forward Deployed Engineer, workflow automation, and internal tools roles otherwise lead with AI Product Design Operating System, then Job Fit Agent, then RWLV Priority Governor Agent. Product Manager roles lead with AI Product Design Operating System, then RWLV Priority Governor Agent, then Job Fit Agent; Lennar Product Manager / Digital Buying & Selling roles prioritize Resorts World digital product and analytics work, AI Marketing Intelligence Platform display naming, AI Product Design Operating System, product discovery, requirements, user behavior, conversion optimization, GA4/GTM/Pendo instrumentation, customer journey, and AI-assisted product lifecycle language. Analytics/product systems roles lead with RWLV Priority Governor Agent, then AI Product Design Operating System, then Job Fit Agent. Generated summaries prefer specific "AI-enabled workflow systems" language instead of defaulting to "AI-native" phrasing.

Before resume generation, a deterministic keyword classifier now selects one of eight resume lanes: product management, data platform/analytics product, AI strategy/transformation, AI systems integration, AI workflow automation/solutions, technical project/program management, product marketing, or local contract consulting. The selected `ResumeStrategy` controls the applicant-facing headline, summary, skills and optional methods section, tools and project ordering, exclusions, and experience emphasis. `resume_strategy.md` records the lane, scores, guidance, and a warning whenever classification falls back to product management at low confidence.
