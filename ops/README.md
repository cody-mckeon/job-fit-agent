...
docker compose run --rm job-fit-agent python -m job_fit_agent.main telegram-command "block-company elevenlabs Ashby 90-day application limit, recruiter/manual review only"
docker compose run --rm job-fit-agent python -m job_fit_agent.main block-company elevenlabs "Ashby 90-day application limit, recruiter/manual review only"
